...
/**
    ...
    public static void main(String []args) throws Exception {  
        ...
        String sql = "select * from t_bookinfo"; // 查询语句  
        Vector<String> columnName = new Vector<String>(); // 列名   
        columnName.add("ISBN号");  //excel中的每个段的名字
        columnName.add("书名");  
        columnName.add("作者");  
        columnName.add("翻译");  
        columnName.add("出版社");  
        ...
        // 导出文件  
        new HistorysaleExcel().WriteExcel(rs, "库存图书基本信息表.xls", "库存图书基本信息", columnName);    
    } 
}
