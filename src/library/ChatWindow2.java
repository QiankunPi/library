...
public class ChatWindow2 extends JFrame {
	...
	private JButton sendButton;
	 ...
	 private SendThread2 sendThread;
	 private ReceiveThread2 receiveThread;
	 
	 private void GUIini(){
	  Container c = this.getContentPane();
	  c.setLayout(new BorderLayout());
	  setBounds(570, 320, 400,500);
	  setTitle("与用户对话");
	  ...
	  this.addKeyListener(new KeyListener() {
	   ...
	   public void keyReleased(KeyEvent e) {
	    ...
	    if(e.getKeyCode() == KeyEvent.VK_ENTER){
	     //发送文本
	     try {
			sendThread.senMessage(InetAddress.getLocalHost().getHostAddress(), 8084, sendText.getText());
	 ...
	 private void ThreadIni() {
	  // TODO Auto-generated method stub
	  sendThread = new SendThread2(0, this);
	  receiveThread = new ReceiveThread2(this);
	 }
	 //构造函数
	 public ChatWindow2() {
	  GUIini();
	 ...
	 public void setReceive(String receive){
	  receiveText.setText(receiveText.getText() + "用户:" + receive+ "\n" );
	 }
