...
/**
    ...
    public static void main(String []args) throws Exception {  
        ...
        String sql = "select * from t_salesdetail"; // 查询语句  
        Vector<String> columnName = new Vector<String>(); // 列名   
        columnName.add("销售单号");  //excel中的每个段的名字
        columnName.add("ISBN号");  
        columnName.add("销售数量");  
        columnName.add("售价");  
        columnName.add("销售金额");  
        columnName.add("销售时间");  
        columnName.add("销售商编号"); 
        columnName.add("经办人");
        ...
        // 导出文件  
        new HistorysaleExcel().WriteExcel(rs, "历史销售信息表.xls", "历史销售信息", columnName);    
    } 
}
